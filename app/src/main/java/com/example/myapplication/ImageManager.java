...
public class ImageManager {
    ...
    public static final String storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=raviraw299;AccountKey=Z1MikP1s66Ne0Clg/rHvLiryRIwi2TwdoR1SCkhUJHcShhtYP72QUnj7Hr7UQ3iabTbGc2DOZOgFHHsvBiR2YA==;EndpointSuffix=core.windows.net";
    ...
    private static CloudBlobContainer getContainer() throws Exception {
        ...
        CloudBlobContainer container = blobClient.getContainerReference("12345node");
